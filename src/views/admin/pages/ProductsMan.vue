...
const saveProduct = async () => {
  ...
  let FUNC_API = data._id
    ? API.updatev2(URL_ENDPOINT, formData)
    : API.create(URL_ENDPOINT, formData);
  try {
                    ...
                    <div class="w-full" v-if="files.length > 0">
                      <div class="flex flex-col w-full gap-4">
                        <div
                          ...
                          :key="index"
                          class="p-4 rounded-border justify-between flex w-full border border-surface items-center gap-4"
                        >
                          <div>
                            <img
                              role="presentation"
                          ...
                          <span
                            class="font-semibold text-ellipsis max-w-96 whitespace-nowrap overflow-hidden"
                            >{{ file.name }}</span
                          >
            ...
            <div class="flex flex-col gap-6">
              <div>
                ...
                <InputText
                  ...
                  required="true"
                  autofocus
                  :invalid="submitted && !productDetail.actorName"
                  fluid
                />
              </div>
              <div>
                ...
                <Textarea
                  v-model="productDetail.descriptions"
                  required="true"
                  rows="3"
                  cols="20"
                  fluid
              ...
              <div>
                ...
                <InputNumber
                  ...
                  required="true"
                  autofocus
                  :invalid="submitted && !productDetail.price"
                  fluid
                />
              </div>
              ...
              <div class="flex gap-2 justify-between items-center">
                <div class="w-full">
                  ...
                  <InputNumber
                    ...
                    required="true"
                    autofocus
                    :invalid="submitted && !productDetail.quantity"
                    fluid
                  />
                </div>
                <div class="w-full">
                  ...
                  <Select
                    v-model="productDetail.madeIn"
                    :options="Nations"
                    option-value="niceName"
                    option-label="niceName"
                    :invalid="submitted && !productDetail.madeIn"
                    fluid
                  />
                </div>
              </div>
              <div class="flex gap-2 justify-between items-center">
                <div class="w-full">
                  ...
                  <InputNumber
                    ...
                    required="true"
                    autofocus
                    :invalid="submitted && !productDetail.age"
                    fluid
                  />
                </div>
                <div class="w-full">
