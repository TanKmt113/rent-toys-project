  ...
  <div>
    <div class="card">
      ...
      >
        ...
        <Column header="Mã đơn hàng" field="_id" style="max-width: 200px">
          <!-- <template #body="{ data }">
        ...
        <template #expansion="slotProps">
          <div class="p-4">
            ...
            <DataTable :value="slotProps.data.items">
              ...
              <Column field="price" header="Đơn giá (VNĐ)" sortable></Column>
              <Column field="discount" header="Giảm giá (%)" sortable></Column>
              <Column field="amount" header="Tổng tiền (VNĐ)" sortable>
                <template #body="slotProps">
