        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-7 flex flex-col gap-3">
            ...
            <div class="flex gap-4">
              <span class="text-2xl font-semibold line-through" v-if="discount(detail)"
                >{{ formatPrice(detail.price) }}đ</span
              >
              <span class="text-2xl font-semibold text-primary"
                >{{
                  discount(detail)
                    ? formatPrice(detail.price - discount(detail))
            ...
            <div class="grid grid-cols-12 text-base">
              <div class="col-span-6">
                <div class="flex flex-col gap-2">
                  ...
                  <div class="flex gap-2">
                    <span>Giới tính: </span>
                    <strong>{{ detail.sex == "M" ? "Nữ" : "Nam" }}</strong>
                  </div>
                </div>
              </div>
              <div class="col-span-6">
...
const items = ref([
  { label: "Trang chủ" },
  { label: "Manga -Comic" },
  { label: "Tuyển tập Doraemon bóng chày - Truyền kì về bóng chày siêu cấp - Tập 2" },
]);
const detail = ref({});
